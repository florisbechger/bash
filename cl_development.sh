...
# Change lib/systemd/network/80-dhcp.network 
# Name=en* to Name=*0s*

# configure bridge for ip-tables:
mkdir /etc/sysctl.d/
echo "net.bridge.bridge-nf-call-arptables = 0" > /etc/sysctl.d/90-bridge.conf
echo "net.bridge.bridge-nf-call-ip6tables = 0" >> /etc/sysctl.d/90-bridge.conf
echo "net.bridge.bridge-nf-call-iptables = 0" >> /etc/sysctl.d/90-bridge.conf
